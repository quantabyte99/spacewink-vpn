...
class AppSettingController extends GetxController {
    ...
    if (apiResponse.response != null &&
      ...
      try {
        ...
        try {
          ...
          // if ads_setting indicates admob, fetch admob config
  ...
  // Convenience getters
  bool get isAnyAdEnabled => admobBannerEnabled || admobNativeEnabled || admobInterstitialEnabled || admobRewardedEnabled || admobOpenEnabled;
