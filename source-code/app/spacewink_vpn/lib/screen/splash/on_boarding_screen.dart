            ...
            Padding(
              ...
              child: Align(
                ...
                child: TextButton(
                  ...
                  child: Text('Skip', style: GoogleFonts.openSans(color: Colors.grey[700])),
                ),
              ),
            ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Select from multiple VPN protocols for optimal speed and security.',
          ...
          Column(
            children: [
              _protocolCard('V2Ray', 'Advanced & Fast', Icons.shield_outlined, const Color(0xFF8B5CF6)),
              const SizedBox(height: 12),
              _protocolCard('WireGuard', 'Modern & Efficient', Icons.flash_on_rounded, const Color(0xFFEC4899)),
              const SizedBox(height: 12),
              _protocolCard('OpenVPN', 'Reliable & Secure', Icons.vpn_key_rounded, const Color(0xFF3B82F6)),
            ],
          ),
          const SizedBox(height: 20),
        ],
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text(
            'Connect to servers worldwide for unrestricted access.',
            style: GoogleFonts.openSans(fontSize: 15, color: const Color(0xFF6B7280)),
            textAlign: TextAlign.center,
          ),
          const SizedBox(height: 32),
          ...
          Column(
            children: [
              _locationTile('🇺🇸', 'United States', 'New York', '12 ms'),
              const SizedBox(height: 12),
              _locationTile('🇬🇧', 'United Kingdom', 'London', '22 ms'),
              const SizedBox(height: 12),
              _locationTile('🇩🇪', 'Germany', 'Frankfurt', '18 ms'),
            ],
          ),
          const SizedBox(height: 20),
        ],
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text(
            'Instant protection with a single tap. Stay secure and browse anonymously.',
            style: GoogleFonts.openSans(fontSize: 15, color: const Color(0xFF6B7280)),
            textAlign: TextAlign.center,
          ),
          const SizedBox(height: 32),
          ...
          Column(
            children: [
              _featureRow(Icons.security_rounded, 'Military-grade encryption', kAccent),
              const SizedBox(height: 12),
              _featureRow(Icons.speed_rounded, 'Lightning-fast speed', kAccent),
              const SizedBox(height: 12),
              _featureRow(Icons.verified_user_rounded, 'Zero logs policy', kAccent),
            ],
          ),
          const SizedBox(height: 30),
        ],
