                  ...
                  child: GetBuilder<OpenVpnController>(builder: (ctrl) {
                    ...
                    return FutureBuilder<String>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (filtered.isEmpty) {
                          return Center(child: Text(_searchQuery.isEmpty ? 'No servers found' : 'No matching servers found', style: GoogleFonts.poppins(color: Colors.black)));
                        }
                                  ...
                                  onTap: () async {
                                    if (item.isPremium) {
                                      ...
                                      if (isPremiumUser) {
                                        ...
                                        Fluttertoast.showToast(msg: 'Server saved', backgroundColor: Colors.green, textColor: Colors.white);
                                          ...
                                          Dialog(
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(mainAxisSize: MainAxisSize.min, children: [
                                                ...
                                                Text('Premium Server', style: GoogleFonts.poppins(color: Colors.black, fontSize: 20, fontWeight: FontWeight.w500), textAlign: TextAlign.center),
                                                const SizedBox(height: 8),
                                                Text('Connect with our premium server by watching an ad, or upgrade to premium for unlimited secure access.', style: GoogleFonts.poppins(color: Colors.black.withValues(alpha: 0.72), fontSize: 14, height: 1.4), textAlign: TextAlign.center),
                                                ...
                                                Column(children: [
                                                  ...
                                                  SizedBox(
                                                    ...
                                                    child: ElevatedButton(
                                                      ...
                                                      child: Text('Buy Premium', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w500, color: Colors.black)),
                                                    ),
                                                  ),
                                                ]),
