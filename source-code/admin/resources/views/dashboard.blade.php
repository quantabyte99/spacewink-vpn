...
<div class="container-fluid py-4 min-vh-100 bg-light">
    ...
    <div class="row mb-4 px-3">
        <div class="col-12 col-xl-8 mb-3 mb-xl-0">
            <h3 class="fw-bold text-dark">Welcome {{ auth('admins')->user()->name }}</h3>
    ...
    <div class="row g-4 mt-3 px-3">
        ...
        <div class="col-md-3">
            <div class="card dashboard-card shadow-sm">
                <div class="card-body text-center py-4">
                    <h6 class="mb-2">Total Wireguard Servers</h6>
        ...
        <div class="col-md-3">
            <div class="card dashboard-card shadow-sm">
                <div class="card-body text-center py-4">
                    <h6 class="mb-2">Total V2ray Servers</h6>
        ...
        <div class="col-md-3">
            <div class="card dashboard-card shadow-sm">
                <div class="card-body text-center py-4">
                    <h6 class="mb-2">Total OpenVpn Servers</h6>
        ...
        <div class="col-md-3">
            <div class="card dashboard-card shadow-sm">
                <div class="card-body text-center py-4">
                    <h6 class="mb-2">Total OpenConnect Servers</h6>
        ...
        <div class="col-md-3">
            <div class="card dashboard-card shadow-sm">
                <div class="card-body text-center py-4">
                    <h6 class="mb-2">Total Subscriptions</h6>
    ...
    <h4 class="text-dark fw-bold">Top 5 Servers</h4>
        <div class="col-12">
