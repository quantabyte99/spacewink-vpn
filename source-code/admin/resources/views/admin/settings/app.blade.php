...
<div class="container-fluid p-0 bg-light min-vh-100">
    <div class="card shadow-none text-light" style="background-color:#eee; border-radius:12px;">
        <div class="p-4">
            ...
            <h3 class="mb-4 text-dark">App Settings</h3>
            ...
            <div class="setting-section mb-4">
                <form action="{{ route('settings.app.update') }}" method="POST">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <label class="form-label mb-0"><i class="fas fa-shield-alt text-info"></i> Privacy Policy</label>
            ...
            <div class="setting-section mb-4">
                <form action="{{ route('settings.app.update') }}" method="POST">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <label class="form-label mb-0"><i class="fas fa-file-contract text-warning"></i> Terms & Conditions</label>
                        <button type="submit" class="btn btn-sm btn-primary btn-hover">
                            <i class="fa fa-save"></i> Update
                        </button>
                    </div>
            ...
            <div class="setting-section mb-4">
                <form action="{{ route('settings.app.update') }}" method="POST">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <label class="form-label mb-0"><i class="fas fa-info-circle text-success"></i> About Us</label>
                        <button type="submit" class="btn btn-sm btn-primary btn-hover">
                            <i class="fa fa-save"></i> Update
                        </button>
                    </div>
            ...
            {{-- App URLs Section --}}
            <h5 class="mb-3 text-dark"><i class="fas fa-link"></i> App URLs</h5>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    <form action="{{ route('settings.app.update') }}" method="POST">
                        ...
                        <label class="form-label">More Apps URL</label>
                ...
                <div class="col-md-4">
                    <form action="{{ route('settings.app.update') }}" method="POST">
                        ...
                        <label class="form-label">Share App URL</label>
                        <div class="input-group">
                            <input type="url" name="value" class="form-control input-dark" 
                ...
                <div class="col-md-4">
                    <form action="{{ route('settings.app.update') }}" method="POST">
                        ...
                        <label class="form-label">Rate App URL</label>
                        <div class="input-group">
                            <input type="url" name="value" class="form-control input-dark" 
