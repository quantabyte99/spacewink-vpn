...
class WireguardController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            return back()->with('done', 'Wireguard server created successfully');
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            if (!$server) {
                return back()->with('not', 'Wireguard server not found');
            }
            ...
            return back()->with('done', 'Wireguard server updated successfully');
    ...
    public function destroy($id)
    {
        try {
            ...
            if (!$server) {
                return back()->with('not', 'Server not found');
            }

            $server->delete();

            return back()->with('done', 'Wireguard server deleted successfully');
    ...
    public function index(Request $request)
    {
        try {
            ...
            return back()->with('not', 'Wireguard server list retrieval failed');
        }
    }
    ...
    public function status(Request $request, $id)
    {
        try {
            ...
            if (!$server) {
                return response()->json(['error' => 'Wireguard not found'], 404);
            }

            $server->status = $request->status;
            $server->save();

            return response()->json(['success' => 'Wireguard status updated successfully']);
