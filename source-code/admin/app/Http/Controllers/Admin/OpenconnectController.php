...
class OpenconnectController extends Controller
{
    public function store(Request $request)
    {
        try {
            ...
            return back()->with('done', 'OpenConnect server created successfully');
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            if (! $server) {
                return response()->json(['error' => 'OpenConnect server not found'], 404);
            }
            ...
            return back()->with('done', 'OpenConnect server updated successfully');
        } catch (\Exception $e) {
            return back()->with('not', $e->getMessage());
        }
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return back()->with('done', 'OpenConnect server Deleted successfully');
    ...
    public function index(Request $request)
{
    try {
        ...
        return back()->with('not', 'OpenConnect server list retrieval failed');
    }
}
    ...
    public function status(Request $request, $id)
    {
        try {
            ...
            if (! $server) {
                return response()->json(['error' => 'OpenConnect not found'], 404);
            }
    
            $server->status = $request->status;
            $server->save();
    
            return response()->json(['success' => 'OpenConnect status updated successfully']);
        } catch (\Exception $e) {
