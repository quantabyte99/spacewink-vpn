...
class UserController extends Controller
{
    ...
    public function register(Request $request)
    {
        try {
           ...
           return back()->with('done', 'User added successfully.');
        } catch (\Exception $e) {
            return back()->with('not', 'Registration failed');
        }
    }
    ...
    public function registerUpdate(Request $request, $id)
    {
        ...
        try{
            ...
            $user->save();
            return back()->with('done', 'User updated successfully.');
        } catch (\Exception $e) {
    ...
    public function index(Request $request)
    {
        try {
            ...
            return back()->with('not', 'User list retrieval failed');
    ...
    public function destroy($id)
    {
        ...
        if ($user) {
            ...
            return back()->with('done', 'Deleted successfully.');
        } else {
            return back()->with('not', 'User not found.');
        }
    }
    ...
    public function order(Request $request){
        try {
            ...
            return back()->with('not', 'Order list retrieval failed');
        }
    }
    ...
    public function orderCancel($id){
        ...
        $user = User::find($order->user_id);
            ...
            return back()->with('done', 'Canceled successfully.');
    }
    ...
    public function orderUpdate(Request $request, $id){
        ...
        $user->save();
        return back()->with('done', 'Updated successfully.');
    }
            ...
            if($user){
               ...
               if(Order::where('user_id', $id)->exists()){
                ...
                return back()->with('done', 'Subscribed successfully.');
                    ...
                    $user->price = NULL;
                    $user->save();
                    return back()->with('done', 'Unsubscribed successfully.');
                }
            }
        } catch (\Exception $e) {
            return back()->with('not', $e->getMessage());
