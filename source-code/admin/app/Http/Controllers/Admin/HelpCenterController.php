...
class HelpCenterController extends Controller
{
    public function index(Request $request)
    {
            ...
            $helpcenters = HelpCenter::query()
                ...
                return back()->with('not', 'Question and answer list retrieval failed');
            }
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return back()->with('done', 'Question and answer created successfully');
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            if (! $helpcenter) {
                return response()->json(['error' => 'Question and answer not found'], 404);
            }
            ...
            return back()->with('done', 'Question and answer updated successfully');
        } catch (\Exception $e) {
            return back()->with('not', $e->getMessage());
        }
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return back()->with('done', 'Question and answer Deleted successfully');
