...
class SubscriptionPlanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('done', 'Subscription Plan added successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->back()->with('done', 'Subscription Plan updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('done', 'Subscription Plan deleted successfully.');
    }
}
